    ...
    return (
        <div className="halloween">
            ...
            <div className="sectionwrapper">
                <div className="text">
                    <p>
                        I always wanted to make a haunted house, which people in my neighborhood typically hold in their garage. 
                        My house only has a one-car garage, which made it a challenge to do much in such a small space, so I decided to take the haunted house outside.
                    ...
                    <p>
                        ...
                        Originally, the LED's came were placed very close together, which looked very strange on the alphabet wall, so I cut each individual LED and manually added more wire in-between all of the LED's. 
                        The LED's coming off the porch did not need as much control, so I just used standard Christmas lights and hooked them up to an Arduino-programmable IoT Power Relay.
                    </p>
                    <p>
